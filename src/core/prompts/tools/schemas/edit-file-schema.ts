...
export function generateEditFileSchema(args: ToolArgs): BaseToolSchema {
		...
		parameters: [
			{
				name: "target_file",
				type: "string",
				description: "The target file to modify. Always specify the full path to the file you want to edit.",
				required: true,
			},
			{
				name: "instructions",
